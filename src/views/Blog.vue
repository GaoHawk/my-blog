          ...
          <side-section>
            <div slot="sidecontent">
              ...
              <div class="social">
                ...
                <a data-balloon="github" href="https://github.com/GaoHawk" rel="nofollow" class="icon"><i class="fa fa-github" style="background-color: #55acee;"></i></a>
                <el-popover
                  ref="youxiang"
                  placement="bottom"
                  title="我的邮箱"
